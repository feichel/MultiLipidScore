...
bind_rows(diab_netcoupler %>% mutate(iter = 1, outcome = "T2D"),
          diab_netcoupler_2 %>% mutate(iter = 2, outcome = "T2D"),
          diab_netcoupler_3 %>% mutate(iter = 3, outcome = "T2D"),
          diab_netcoupler_4 %>% mutate(iter = 4, outcome = "T2D"),
          cvd_netcoupler %>% mutate(iter = 0, outcome = "CVD"),
          cvd_netcoupler_2 %>% mutate(iter = 1, outcome = "CVD"),
          cvd_netcoupler_3 %>% mutate(iter = 2, outcome = "CVD")) %>%
